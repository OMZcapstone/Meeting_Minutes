...
- **정량지표 확정**: 2개 (주행 성능 + 센서 반응속도)
- **하드웨어 설계**: 엔코더 모터 4개 + 10인치 바퀴 + 라이다 센서
- **발표 준비**: 구현설계 발표 (10/16) 최종 준비 중

### 개발 계획
- **정량지표 1**: 지하주차장 안정적 주행 (90점 합격 기준)
  - 운전면허 기능시험 기준 적용
  - 출발, 직진, 곡선로, 과속방지턱, 정지, 비상정지
- **정량지표 2**: 라이다 기반 장애물 반응 (1.5초 이내)
  - 반응시간 측정 및 회피 성공률 평가
- **하드웨어**: 엔코더 모터(32만원), 10인치 바퀴, 라이다 센서
- **소프트웨어**: 3단계 주차라인 인식, QR코드 위치 확인
